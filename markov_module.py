...
def open_and_read_files(input_file):
    ...
    file_contents = open(input_file).read()
...
def make_chains(text_string, length_of_n):
...
def make_text(chains, start_sentences, length_of_n):
...
# input_text = open_and_read_files(input_file)
